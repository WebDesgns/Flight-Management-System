...
public class FlightServiceImpl implements FlightService {
	...
	public Flight viewFlight(BigInteger flightNumber) {
		...
		if (findById.isPresent()) {
			...
			throw new ResourceNotFoundException("Flight with number: " + flightNumber + " not exists");
	    }
	...
	public Flight modifyFlight(Flight flight) {
		...
		if (findById.isPresent()) {
			...
			throw new ResourceNotFoundException("Flight with number: " + flight.getFlightNo() + " not exists");
		return flight;
	}
